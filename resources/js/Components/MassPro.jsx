                ...
                <table className='masspro-table' border={1}>
                    <thead>
                        ...
                        <tr>
                            ...
                            <th rowSpan={2} className="worst">Worst <button class="copy-btn" onClick={(e) => copyPaste(worstData)}>Copy</button> </th>
                        </tr>
                        <tr>
                            ...
                            Array.from
                                (
                                    { length: numberOfPoints }, (_, i) => {
                                        judegement && judegement[i + 1].worst && judegement[i + 1]?.worst !== undefined ? worstData.push(judegement[i + 1].worst) : worstData.push('')
                                        return (
                                            <tr key={i + 1}>
